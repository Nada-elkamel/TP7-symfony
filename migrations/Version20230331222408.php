 ...
 */
final class Version20230331222408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(255) DEFAULT NULL');
